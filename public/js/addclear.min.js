...
n.hideOnBlur&&setTimeout(function(){i(t).siblings("a[href='#clear']").hide()},50)}),t.keyup(function(){i(this).val().length>=1?i(this).siblings("a[href='#clear']").show():i(this).siblings("a[href='#clear']").hide()}),i("a[href='#clear']").click(function(t){i(this).siblings(e.element).val(""),i(this).hide(),n.returnFocus===!0&&i(this).siblings(e.element).focus(),n.onClear&&n.onClear(i(this).siblings("input")),t.preventDefault(),t.stopPropagation()})}},i.fn[o]=function(t){return this.each(function(){i.data(this,"plugin_"+o)||i.data(this,"plugin_"+o,new s(this,t))})}}(jQuery,window,document)
