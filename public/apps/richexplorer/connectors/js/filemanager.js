...
module.exports = (__appRoot) => { // eslint-disable-line max-statements
    ...
    switch (mode.trim()) {
case 'initiate':
	respond(res, JSON.parse('{"data": {"id": "/","type": "initiate","attributes": {"config": {"security": {"readOnly": true,"extensions": {"policy": "ALLOW_LIST","ignoreCase": true,"restrictions": ["jpg","jpe","jpeg","gif","png"]}},"upload": {"fileSizeLimit": 16000000}}}}}'));
